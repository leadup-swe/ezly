  ...
  .mutation(
    async ({
      ...
      if (sourceColumnId === destinationColumnId) {
        ...
        const sourceColumnTasksOrder = JSON.parse(
          sourceColumn?.tasksOrder || "[]"
        );

        const destinationColumn = project.columns.find(
          (column) => column.id === destinationColumnId
        );
        const destinationColumnTasksOrder = JSON.parse(
          destinationColumn?.tasksOrder || "[]"
        );
