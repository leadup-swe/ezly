...
const Page: NextPageWithLayout = () => {
  ...
  const { project, columnsOrder, createColumn, createTask, moveTask } = useProject({ projectId });
  ...
  const handleTaskAdd = useCallback(async (columnId: string, title?: string): Promise<void> => {
