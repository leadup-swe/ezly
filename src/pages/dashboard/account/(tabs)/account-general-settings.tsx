...
import { Avatar, Box, Button, Card, CardContent, Divider, Stack, SvgIcon, Switch, TextField, Typography, Unstable_Grid2 as Grid } from '@mui/material';
...
export const AccountGeneralSettings = ({ avatar, email, name, ...props }: AccountGeneralSettingsProps) => (
