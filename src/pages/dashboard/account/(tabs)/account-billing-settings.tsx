...
import { PropertyList, PropertyListItem } from '@atoms/property-list';
...
export const AccountBillingSettings = ({ plan: currentPlan = 'standard', invoices = [], ...props }: AccountBillingSettingsProps) => {
