...
import { CompanyJobs } from '@molecules/company-jobs';
  ...
  return (
    <Card {...other}>
      <CardContent>
        ...
        >
          <Avatar component={Link} href='' src={company.logo} variant='rounded'>
            {getInitials(company.name)}
          </Avatar>
          <div>
            <Link color='text.primary' component={Link} href='' variant='h6'>
              {company.name}
            </Link>
