...
export const Board = ({ projectId, arrangement }: Props) => {
  const { columnsOrder, columnCreate, taskMove, columnClear, columnDelete } = useProject({ projectId });
